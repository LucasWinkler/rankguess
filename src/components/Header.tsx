        ...
        <div className='flex w-full items-center justify-between gap-2 text-neutral-300'>
          ...
          <nav
            className={clsx(
              ...
              isMobileMenuOpen
                ? 'absolute left-0 top-navigation-height right-0 block h-[calc(100%-var(--navigation-height))] overflow-y-auto border-t border-t-blueish-grey-700/25 bg-blueish-grey-800'
                : 'hidden'
            )}>
            <ConditionalWrapper
